...
- Ensure that your origin web server is actively bound and listening on the port required by your Cloudflare SSL/TLS mode: Port 80 for **Flexible** mode, or Port 443 for **Full** and **Full (Strict)** modes.
